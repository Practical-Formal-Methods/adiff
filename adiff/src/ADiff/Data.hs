...
instance Database be ADiffDb

adiffDbChecked :: CheckedDatabaseSettings be ADiffDb
adiffDbChecked = defaultMigratableDbSettings @SqliteCommandSyntax `withDbModification` modification
  where
...
adiffDb :: DatabaseSettings be ADiffDb
adiffDb = unCheckDatabase adiffDbChecked

migrateAdiff :: SqliteM ()
migrateAdiff = autoMigrate migrationBackend adiffDbChecked
