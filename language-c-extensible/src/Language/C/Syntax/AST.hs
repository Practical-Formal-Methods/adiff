...
deriving instance Eq (CAlignmentSpecifier NodeInfo)
...
deriving instance Eq (CStorageSpecifier NodeInfo)
deriving instance Eq (CConstant NodeInfo)
deriving instance Eq (CFunctionSpecifier NodeInfo)


deriving instance Ord (CAlignmentSpecifier NodeInfo)
...
deriving instance Ord (CStorageSpecifier NodeInfo)
deriving instance Ord (CConstant NodeInfo)
deriving instance Ord (CFunctionSpecifier NodeInfo)
...
data CStructTag = CStructTag
                | CUnionTag
                deriving (Ord,Show,Eq,Data,Typeable, Generic)
